...
- Reduced the Swift tools requirement from 6.2 to 6.0 while retaining Swift 6 strict concurrency
- CI now builds for the iOS 17 deployment target and tests on the latest available iOS runtime
